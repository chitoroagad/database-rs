const BTREE_PAGE_SIZE: u64 = 4096;
...
mod node {
    ...
    struct BNode<'a> {
        data: &'a mut [u8; BTREE_PAGE_SIZE as usize],
    }
    ...
    impl<'a> BNode<'a> {
        ...
        fn set_header(self, btype: u16, nkeys: u16) {
        ...
        fn set_ptr(self, idx: u16, val: u64) {
...
mod tests {
    ...
    fn max_node_size_fits_in_page() {
        assert!(BTREE_MAX_NODE_SIZE <= BTREE_PAGE_SIZE);
    }
}
